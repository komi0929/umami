...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-muted pt-16 pb-8 border-t border-section-divider">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-sm">
            ...
            <p className="text-sm text-text-secondary leading-relaxed">
              インバウンド需要・アレルギー対応に最適化した、次世代の業務用ヴィーガンアイスクリーム。
            </p>
          </div>
          ...
          <div className="flex gap-12 text-center md:text-left">
            <div className="flex flex-col gap-3">
              <Link href="#product-lines" className="text-text-secondary hover:text-accent transition-colors text-sm">
                ラインナップ
              </Link>
              <Link href="#business-value" className="text-text-secondary hover:text-accent transition-colors text-sm">
                収益性
              </Link>
            </div>
            <div className="flex flex-col gap-3">
              <Link href="#conversion-cta" className="text-text-secondary hover:text-accent transition-colors text-sm font-medium">
                無料サンプル請求
              </Link>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-border-light relative">
          <p className="text-xs text-text-muted">
            &copy; 2026 UMAMI VANILLA. All rights reserved.
          </p>
          
          <div className="flex items-center gap-4">
            <a href="#" className="p-2.5 rounded-full text-text-muted hover:text-accent hover:bg-sand/50 transition-all inline-flex items-center justify-center">
